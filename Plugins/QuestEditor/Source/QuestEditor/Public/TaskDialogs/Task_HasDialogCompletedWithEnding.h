...
#include "Task_HasDialogCompletedWithEnding.generated.h"
...
class QUESTEDITOR_API UTask_HasDialogCompletedWithEnding : public UBaseQuestTask, public IQuestTaskInterface
{
