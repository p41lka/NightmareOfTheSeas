...
#include "Task_RemoveDialogFromFailTrack.generated.h"
...
class QUESTEDITOR_API UTask_RemoveDialogFromFailTrack : public UBaseQuestTask, public IQuestTaskInterface
{
...
public:
	...
	UTask_RemoveDialogFromFailTrack();
