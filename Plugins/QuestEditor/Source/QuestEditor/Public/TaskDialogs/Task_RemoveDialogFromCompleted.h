...
#include "Task_RemoveDialogFromCompleted.generated.h"
...
class QUESTEDITOR_API UTask_RemoveDialogFromCompleted : public UBaseQuestTask, public IQuestTaskInterface
{
...
public:
	...
	UTask_RemoveDialogFromCompleted();
