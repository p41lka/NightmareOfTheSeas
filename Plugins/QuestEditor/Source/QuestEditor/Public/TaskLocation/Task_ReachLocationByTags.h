...
#include "Task_ReachLocationByTags.generated.h"
...
UCLASS(BlueprintType, Meta = (DisplayName = "ReachLocationByTagsTask"))
class QUESTEDITOR_API UTask_ReachLocationByTags : public UBaseQuestTask_Location
{
	GENERATED_BODY()

public:

	UTask_ReachLocationByTags();
