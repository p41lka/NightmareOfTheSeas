...
#include "Task_RemoveQuestFromCompleted.generated.h"
...
class QUESTEDITOR_API UTask_RemoveQuestFromCompleted : public UBaseQuestTask, public IQuestTaskInterface
{
...
public:
	...
	UTask_RemoveQuestFromCompleted();
