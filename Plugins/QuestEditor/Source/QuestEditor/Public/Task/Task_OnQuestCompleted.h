...
#include "Task_OnQuestCompleted.generated.h"
...
class QUESTEDITOR_API UTask_OnQuestCompleted : public UBaseQuestTask, public IQuestTaskInterface
{
...
protected:
	...
	UFUNCTION()
	void OnQuestEventCallback(const FQuest& QuestIn, int CompletedSlotIn);
