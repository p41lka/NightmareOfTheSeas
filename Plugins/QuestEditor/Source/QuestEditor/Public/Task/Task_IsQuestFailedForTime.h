...
#include "Task_IsQuestFailedForTime.generated.h"
...
class QUESTEDITOR_API UTask_IsQuestFailedForTime : public UBaseQuestTask , public IQuestTaskInterface
{
