...
#include "Task_RemoveQuestFromFailTrack.generated.h"
...
class QUESTEDITOR_API UTask_RemoveQuestFromFailTrack : public UBaseQuestTask, public IQuestTaskInterface
{
...
public:
	...
	UTask_RemoveQuestFromFailTrack();
