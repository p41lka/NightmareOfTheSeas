...
#include "Task_ResetTrackToNodeWithDisableds.generated.h"
...
class QUESTEDITOR_API UTask_ResetTrackToNodeWithDisableds : public UBaseQuestTask, public IQuestTaskInterface
{
...
public:
	...
	UTask_ResetTrackToNodeWithDisableds();
