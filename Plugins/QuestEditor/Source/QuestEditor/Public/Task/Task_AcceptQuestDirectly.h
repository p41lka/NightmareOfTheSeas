...
#include "Task_AcceptQuestDirectly.generated.h"
...
class QUESTEDITOR_API UTask_AcceptQuestDirectly : public UBaseQuestTask, public IQuestTaskInterface
{
