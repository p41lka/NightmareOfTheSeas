...
#include "Task_ResetTrackBetweenNodes.generated.h"
...
class QUESTEDITOR_API UTask_ResetTrackBetweenNodes : public UBaseQuestTask, public IQuestTaskInterface
{
